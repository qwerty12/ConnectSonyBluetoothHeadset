...
VA_SetDefaultEndpoint(device_desc="playback", role=0)
{
    /* Roles:
...
VA_ISimpleAudioVolume_GetMasterVolume(this, ByRef Level) {
    return DllCall(NumGet(NumGet(this+0)+4*A_PtrSize), "ptr", this, "float*", Level)
}
VA_ISimpleAudioVolume_SetMasterVolume(this, Level, EventContext="") {
    return DllCall(NumGet(NumGet(this+0)+3*A_PtrSize), "ptr", this, "float", Level, "ptr", VA_GUID(EventContext))
}
VA_ISimpleAudioVolume_SetMute(this, Mute, EventContext="") {
    return DllCall(NumGet(NumGet(this+0)+5*A_PtrSize), "ptr", this, "int", Mute, "ptr", VA_GUID(EventContext))
}
VA_ISimpleAudioVolume_GetMute(this, ByRef Mute) {
    return DllCall(NumGet(NumGet(this+0)+6*A_PtrSize), "ptr", this, "int*", Mute)
}
...
VA_xIPolicyConfig_SetDefaultEndpoint(this, DeviceId, Role) {
    return DllCall(NumGet(NumGet(this+0)+13*A_PtrSize), "ptr", this, "wstr", DeviceId, "int", Role)
}
